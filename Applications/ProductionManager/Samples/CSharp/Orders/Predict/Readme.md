...
> For a detailed example on how to use the outcome of import job, please refer to <i>GetImportOrderStateAsync</i> in the file [ImportOrdersSamples.cs](../../../../Samples/CSharp/Orders/Import/ImportOrderSamples.cs).
