...
/// <summary>
/// Represents a request for CNC duration prediction.
/// </summary>
/// <example>
/// {
...
///       "width": 480,
///       "thickness": 19.0,
///       "cncProgramName1": "Drilling_Main.mpr",
///       "unitSystem": "Metric"
///     }
///   ]
/// }
/// </example>
public class CncPredictionRequest
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the parts for which the CNC duration prediction should be calculated.
    /// </summary>
    /// <example>
    /// [
    ///   {
