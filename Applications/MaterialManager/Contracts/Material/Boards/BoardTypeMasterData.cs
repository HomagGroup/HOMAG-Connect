...
{
    /// <summary>
    /// Represents the master data of a board type including material classification, dimensions, manufacturer data, and optimization settings, excluding inventory data.
    /// </summary>
    /// <example>
    /// { "boardCode": "P2_Gold_Craft_Oak_19.0", "materialCode": "P2_Gold_Craft_Oak", "thickness": 19.0, "materialCategory": "ParticleBoard", "coatingCategory": "MelamineResinCoated", "standardQuality": "P2", "width": 2070.0, "length": 2800.0, "grain": "Lengthwise", "costs": 12.45, "density": 650.0, "boardTypeType": "Stock", "manufacturerName": "HOMAG Sample Supplier", "productName": "Gold Craft Oak", "unitSystem": "Metric" }
    /// </example>
    [DebuggerDisplay("{BoardCode}")]
    public class BoardTypeMasterData : IContainsUnitSystemDependentProperties, ISupportsLocalizedSerialization, ISupportsAdditionalProperties
    {
#pragma warning disable S109 // Magic numbers should not be used
        ...
        /// <summary>
        /// Gets or sets the decor identifier to be used as reference for the decor catalog.
        /// </summary>
        ...
        [Obsolete ("use ExternalSystemId instead", true)]
