...
namespace HomagConnect.OrderManager.Contracts
{
    ...
    public interface IOrderManagerClient
    {
        ...
        /// <returns></returns>
        public Task DeleteOrdersByOrderIds(IEnumerable<Guid> orderIds);
        ...
        /// <returns></returns>
        public Task DeleteOrdersByOrderNumbers(IEnumerable<string> orderNumbers);
        ...
        /// <returns></returns>
        public Task DeleteOrdersByOrderId(Guid orderId);
