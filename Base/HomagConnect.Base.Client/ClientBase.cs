...
public class ClientBase
{
    ...
    /// Creates a new instance of the service base
    /// </summary>
    protected ClientBase(Guid subscriptionOrPartnerId, string authorizationKey)
    {
    ...
    /// Creates a new instance of the service base
    /// </summary>
    protected ClientBase(Guid subscriptionOrPartnerId, string authorizationKey, Uri baseUri)
    {
